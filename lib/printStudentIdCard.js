...
export function openStudentIdCardPrintWindow(student, options = {}) {
  ...
  const opts = {
    ...
    // If you want a QR code, provide a URL here. (Uses an external QR service.)
    qrUrl: options.qrUrl || '',
  };
  ...
  const logoHtml = opts.logoUrl
    ? `<img class="logo-img" alt="Logo" src="${safe(opts.logoUrl)}" />`
      ...
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .back {
          ...
          gap: 10px;
          height: calc(2.125in - 44px); /* rough: header + footer */
        }
        .if-found {
        ...
        .small { font-size: 8px; color: #6b7280; margin-top: 6px; }
        .sig {
          margin-top: 8px;
          padding-top: 8px;
          border-top: 1px solid #e5e7eb;
        ...
        <div class="page" id="frontPage">
          <div class="card">
            ...
            <div class="body">
              ...
              <div>
                <div class="name">${safe(fullName || 'Student')}</div>
                <div class="meta">
                  <div>
          ...
          <div class="card">
            ...
            <div class="back">
              <div class="if-found">
                ...
                ${safe(opts.schoolName)}<br/>
                ${safe(opts.address)}<br/>
                <span class="small">Phone: ${safe(opts.phone)} • Web: ${safe(opts.website)}</span>
                <div class="sig">
                  <div style="flex:1;">
                    <div class="line"></div>
                ...
                <div class="small">This card is the property of ${safe(opts.schoolName)}. Misuse may result in disciplinary action.</div>
              </div>
              <div style="display:flex; flex-direction:column; gap:8px; align-items:flex-end; justify-content:space-between;">
                ${qrImg || '<div style="width:92px;height:92px;border:1px solid #e5e7eb;border-radius:8px;background:#f9fafb;display:flex;align-items:center;justify-content:center;color:#9ca3af;font-size:8px;text-align:center;padding:8px;">QR optional</div>'}
