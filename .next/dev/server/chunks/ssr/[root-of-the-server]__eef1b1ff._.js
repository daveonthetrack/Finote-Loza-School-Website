...
"[project]/Finote Loza/finote-loza-school/pages/admin/articles/[id].js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditArticle() {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (!id) return;
        (async ()=>{
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('articles').select('*').eq('id', id).single();
            if (data) setForm({
                title: data.title || '',
                slug: data.slug || '',
    ...
    async function save(e) {
        e.preventDefault();
        setSaving(true);
        await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('articles').update({
            title: form.title,
            slug: form.slug,
    ...
    async function uploadCover(e) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('assets').upload(path, file, {
            upsert: true,
            cacheControl: '3600',
        ...
        const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('assets').getPublicUrl(path);
        setForm((f)=>({
                ...f,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eef1b1ff._.js.map