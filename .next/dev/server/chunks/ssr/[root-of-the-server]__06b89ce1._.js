...
"[project]/Finote Loza/finote-loza-school/pages/news/[slug].js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getStaticPaths() {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('articles').select('slug');
...
async function getStaticProps({ params }) {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('articles').select('id,title,slug,excerpt,content,cover_url,author,published_at').eq('slug', params.slug).single();
    if (!data) {
        return {
            notFound: true,
            revalidate: 60
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06b89ce1._.js.map