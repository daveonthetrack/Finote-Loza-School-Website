...
"[project]/Finote Loza/finote-loza-school/pages/admin/teacher-debug.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TeacherDebug() {
    ...
    async function testLogin() {
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
            ...
            const { data: teacher, error: teacherError } = await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('teachers').select('*').eq('user_id', data.user.id).single();
            if (teacherError) {
    ...
    async function listTeachers() {
        ...
        setResult('');
        try {
            const { data: teachers, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('teachers').select('teacher_id, first_name, last_name, email, user_id').order('created_at', {
                ascending: false
            });
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3299443d._.js.map