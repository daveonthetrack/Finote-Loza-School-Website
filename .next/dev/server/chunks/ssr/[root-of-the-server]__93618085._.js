...
"[project]/Finote Loza/finote-loza-school/pages/admin/events/index.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EventsAdmin() {
    ...
    async function load() {
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('events').select('id,title,location,start_at,updated_at').order('start_at', {
            ascending: true
        });
        setEvents(data || []);
    }
    async function remove(id) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$Finote__Loza$2f$finote$2d$loza$2d$school$2f$lib$2f$supabaseClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('events').delete().eq('id', id);
        load();
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__93618085._.js.map